...
```{r}
# I had to manaully add the lon lat values in for some points, 
...
vario_emp <- variog(geo_data, max.dist = 600)  # adjust max.dist depending on spread of locations

plot(vario_emp,
     main = "Empirical Variogram of Maximum Temperatures (13 Dec 2012)",
     xlab = "Distance",
     ylab = "Semivariance")
...
```{r}
# Exponential model
vexp <- variofit(vario_emp, cov.model = "exponential")

# Spherical model
vsph <- variofit(vario_emp, cov.model = "spherical")

# Gaussian model
vgaus <- variofit(vario_emp, cov.model = "gaussian")

# Plot
plot(vario_emp, pch = 1)
lines(vexp, col = "blue")
lines(vsph, col = "red")
lines(vgaus, col = "green")
