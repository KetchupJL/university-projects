...
#| fig-cap: "Spatial distribution of Sea Surface Temperature (SST) observations collected on 1–2 January 1996 in the Kuroshio Current region. Each point represents an individual measurement; colour denotes temperature, with warmer SSTs concentrated in the north-east band."
#| echo: true
#| warning: false
#| message: false
#| fig-width: 6
...
#| fig-cap: "Empirical variograms computed using three different maximum distance thresholds. The max.dist = 7 version was selected for model fitting due to reduced instability in the tail while preserving the spatial structure."
#| echo: true
#| warning: false
#| message: false
#| fig-width: 6
...
#| fig-cap: "Observed vs predicted sea surface temperature (SST) at five withheld locations using ordinary kriging with the fitted Matérn model."
#| echo: true
#| warning: false
#| message: false
...
-   The **Q–Q plot** and **histogram** indicate approximate normality, although slight deviations in the Q–Q plot mid-section suggest some trends not fully captured by the model.
...
## Part E: Bayesian Parameter Estimation
...
```{r}
#| label: tab:amocsummary
#| tbl-cap: "Expanded summary statistics of AMOC time series from October 2017 to February 2023."
#| echo: true
#| warning: false
#| message: false
library(dplyr)
...
amoc_summary %>%
  ...
  knitr::kable(
    caption = "Aummary statistics of AMOC time series from October 2017 to February 2023.",
...
## Part B: Monthly Modelling of AMOC
...
```{r}
#| label: fig:acf-pacf-quarterly-differenced
#| fig-cap: "ACF and PACF of Quarterly AMOC (Differenced)"
# First-order differencing
...
```{r}
#| label: tab:arimaquarterlycomp
#| tbl-cap: "Comparison of ARIMA models fitted to quarterly AMOC data."
...
#| fig-cap: "Residual Plots of ARIMA(1,1,1) and auto.arima"
...
```{r}
#| label: tab:arimaquarterly
#| tbl-cap: "Comparison of manual ARIMA(1,1,1) and auto.arima models fitted to quarterly AMOC data."
#| echo: true
#| warning: false
#| message: false
data.frame(
  Model = c(
    "ARIMA(1,1,1)",
    paste0("auto.arima (", auto_arima$arma[1], ",1,", auto_arima$arma[2], ")")
  ),
  ...
  knitr::kable(
    caption = "Comparison of manual ARIMA(1,1,1) and auto.arima models fitted to quarterly AMOC data.",
...
#| message: false
#| warning: false
#| label: fig:monthlydml
#| fig-cap: "Seasonal differencing Plot with lag 12"
...
#| message: false
#| warning: false
#| label: fig:monthlydmlresid
#| fig-cap: "Monthly DLM Residuals"
par(mfrow=c(1,3))
...
#| message: false
#| warning: false
#| label: fig:qrdmlresid
#| fig-cap: "Residual Diagnostics for Quarterly DLM"

# Residual Diagnostics for Quarterly DLM
par(mfrow=c(1,3))
...
-   Ljung-Box test (lag=5): *p* = 0.114 → No evidence of residual autocorrelation.

-   ARCH LM test (lags=5): *p* = 0.134 → No evidence of conditional heteroscedasticity.
...
```{r}
#| label: fig:1234
#| fig-cap: "Empirical Variogram of Max Temp (13 Dec 2012)"
